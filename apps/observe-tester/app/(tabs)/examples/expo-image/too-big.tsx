...
// area against the screen budget (screen area × pixel ratio × 2) and logs an `expo-image.oversized`
// warning because it is far beyond what any full-screen image needs. Use `maxWidth`/`maxHeight`
// (see the "Correctly sized" page) to avoid this.
const SIZE = 220;
